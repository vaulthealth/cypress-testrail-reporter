                ...
                */
                _this.testRailApi.getRuns().then(function (res) {
                    ...
                    if (_this.suiteId === platformSuiteIds["MONOREPO"]) {
                        name = "".concat(_this.reporterOptions.runName || 'Automated regression test run for', " ").concat(executionDateTime);
                    }
                    else if (_this.suiteId === platformSuiteIds["LS"]) {
                        name = "".concat(_this.reporterOptions.runName || 'LS - Automated regression test run for', " ").concat(executionDateTime);
                    }
